...
class RelacionController extends Controller
{
	...
	{
		$idProducto = $request->Input('productoSelec');
		$url = "/relacion";
		...
		$relacion->idUsuario = $request->Input('usuarioSelec');
		$relacion->idProducto = $request->Input('productoSelec');
		$estrategia = new Estrategia();
		$estrategia->idProducto = $request->Input('productoSelec');
		$producto =DB::table('estrategia')->select('idProducto')->where('idProducto', '=', $idProducto)->get();
		$update = DB::table('producto')->where('id', $idProducto)->update(['estado' => $request->Input('estado')]);
